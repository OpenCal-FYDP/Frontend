...
// Source: clients/preference-management/service.proto
...
export function createPreferenceManagementService(service) {
  return {
...
export const GetUserProfileReq = {
  ...
  encodeJSON: function (msg) {
    return JSON.stringify(GetUserProfileReq._writeMessageJSON(msg));
  },
...
export const Settings = {
   ...
   */
  encodeJSON: function (msg) {
    return JSON.stringify(Settings._writeMessageJSON(msg));
  },
   ...
   */
  _readMessageJSON: function (msg, json) {
    const _timeZone = json.timeZone;
    if (_timeZone) {
      msg.timeZone = _timeZone;
    }
    const _fullName = json.fullName;
    if (_fullName) {
      msg.fullName = _fullName;
    }
    const _timeFormat = json.timeFormat;
    if (_timeFormat) {
      msg.timeFormat = _timeFormat;
    }
    const _shouldDefragMeetings = json.shouldDefragMeetings;
    if (_shouldDefragMeetings) {
      msg.shouldDefragMeetings = _shouldDefragMeetings;
    }
    const _AvoidMorningMeetings = json.AvoidMorningMeetings;
    if (_AvoidMorningMeetings) {
      msg.AvoidMorningMeetings = _AvoidMorningMeetings;
    }
    return msg;
  },
};
...
export const GetUserProfileRes = {
   ...
   */
  encodeJSON: function (msg) {
    return JSON.stringify(GetUserProfileRes._writeMessageJSON(msg));
  },
  ...
  _readMessageJSON: function (msg, json) {
    ...
    const _timeAvailability = json.timeAvailability;
    if (_timeAvailability) {
      msg.timeAvailability = _timeAvailability;
    }
    const _bookingLinks = json.bookingLinks;
    if (_bookingLinks) {
      msg.bookingLinks = _bookingLinks;
    }
    const _settings = json.settings;
    if (_settings) {
      const m = Settings.initialize();
      Settings._readMessageJSON(m, _settings);
      msg.settings = m;
    }
    return msg;
  },
...
export const GetAvailabilityReq = {
   ...
   */
  encodeJSON: function (msg) {
    return JSON.stringify(GetAvailabilityReq._writeMessageJSON(msg));
  },
...
export const GetAvailabilityRes = {
   ...
   */
  encodeJSON: function (msg) {
    return JSON.stringify(GetAvailabilityRes._writeMessageJSON(msg));
  },
...
export const GetBookingReq = {
   ...
   */
  encodeJSON: function (msg) {
    return JSON.stringify(GetBookingReq._writeMessageJSON(msg));
  },
  ...
  _readMessageJSON: function (msg, json) {
    ...
    const _bookingLinkID = json.bookingLinkID;
    if (_bookingLinkID) {
      msg.bookingLinkID = _bookingLinkID;
    }
    return msg;
  },
};
...
export const GetBookingRes = {
   ...
   */
  encodeJSON: function (msg) {
    return JSON.stringify(GetBookingRes._writeMessageJSON(msg));
  },
   ...
   */
  _readMessageJSON: function (msg, json) {
    const _isActive = json.isActive;
    if (_isActive) {
      msg.isActive = _isActive;
    }
    const _isMultiUse = json.isMultiUse;
    if (_isMultiUse) {
      msg.isMultiUse = _isMultiUse;
    }
    const _attendees = json.attendees;
    if (_attendees) {
      msg.attendees = _attendees;
    }
    const _conferencing = json.conferencing;
    if (_conferencing) {
      msg.conferencing = _conferencing;
    }
    const _timeIncrements = json.timeIncrements;
    if (_timeIncrements) {
      msg.timeIncrements = _timeIncrements;
    }
    const _recurrence = json.recurrence;
    if (_recurrence) {
      msg.recurrence = _recurrence;
    }
    const _availabilityToUse = json.availabilityToUse;
    if (_availabilityToUse) {
      msg.availabilityToUse = _availabilityToUse;
    }
    return msg;
  },
};
...
export const SetUserProfileReq = {
   ...
   */
  encodeJSON: function (msg) {
    return JSON.stringify(SetUserProfileReq._writeMessageJSON(msg));
  },
...
export const SetAvailabilityReq = {
   ...
   */
  encodeJSON: function (msg) {
    return JSON.stringify(SetAvailabilityReq._writeMessageJSON(msg));
  },
...
export const SetBookingReq = {
   ...
   */
  encodeJSON: function (msg) {
    return JSON.stringify(SetBookingReq._writeMessageJSON(msg));
  },
